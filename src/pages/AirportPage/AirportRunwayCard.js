            ...
            <div className="mb-2">
              <div className="flex justify-between">
                ...
                <span>
                  ...
                  <span className="text-sm"> {t("aiportPage.kts")}</span>
                </span>
              </div>
              <div className="flex justify-between">
                <span className=""> {t("aiportPage.Crosswind")}:</span>{" "}
                <span>
                  <span className="font-mono font-semibold">
              ...
              <div style={{ marginTop: -10 }}>
                <span className="text-xs font-bold">
                  {t("aiportPage.Crosswind")} {t("aiportPage.from")}{" "}
                  {active.crosswindSide}
                </span>
              </div>
            </div>
          ) : null}
          <div className="flex justify-between">
            <span className="">{t("aiportPage.Heading")}:</span>{" "}
            <span>
              <span className="font-mono font-semibold">
                {round(props.heading)}
              </span>{" "}
